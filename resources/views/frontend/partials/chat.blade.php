      ...
      <div class="chat-widget-message">
        <div class="user-status">
            <div class="user-status-avatar">
                <div class="user-avatar small no-outline online">
                    <div class="user-avatar-content">
                        <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/07.jpg') }}"></div>
                    </div>
                    <div class="user-avatar-progress">
                        <div class="hexagon-progress-40-44"></div>
                    </div>
    ...
    <div class="chat-widget-message">
        <div class="user-status">
            <div class="user-status-avatar">
                <div class="user-avatar small no-outline offline">
                    <div class="user-avatar-content">
                        <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/02.jpg') }}"></div>
                    </div>
                    <div class="user-avatar-progress">
                        <div class="hexagon-progress-40-44"></div>
                    </div>
    ...
    <div class="chat-widget-message">
        <div class="user-status">
            <div class="user-status-avatar">
                <div class="user-avatar small no-outline online">
                    <div class="user-avatar-content">
                        <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/08.jpg') }}"></div>
                    </div>
                    <div class="user-avatar-progress">
                        <div class="hexagon-progress-40-44"></div>
                    </div>
    ...
    <div class="chat-widget-message">
        <div class="user-status">
            <div class="user-status-avatar">
                <div class="user-avatar small no-outline online">
                    <div class="user-avatar-content">
                        <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/14.jpg') }}"></div>
                    </div>
                    <div class="user-avatar-progress">
                        <div class="hexagon-progress-40-44"></div>
                    </div>
    ...
    <aside id="chat-widget-message" class="chat-widget chat-widget-overlay hidden sidebar right">
        <div class="chat-widget-header">
            ...
            <div class="user-status">
                <div class="user-status-avatar">
                    <div class="user-avatar small no-outline online">
                        <div class="user-avatar-content">
                            <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/03.jpg') }}"></div>
                        </div>
                        <div class="user-avatar-progress">
                            <div class="hexagon-progress-40-44"></div>
                        </div>
        ...
        <div class="chat-widget-conversation" data-simplebar>
            <div class="chat-widget-speaker left">
                <div class="chat-widget-speaker-avatar">
                    <div class="user-avatar tiny no-border">
                        <div class="user-avatar-content">
                            <div class="hexagon-image-24-26" data-src="{{ asset('assets/img/avatar/03.jpg') }}"></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="chat-widget-speaker left">
                ...
                <p class="chat-widget-speaker-message">What's new with you?</p>
                <p class="chat-widget-speaker-timestamp">Yesterday at 8:36PM</p>
            </div>
            <div class="chat-widget-speaker right">
                <p class="chat-widget-speaker-message">Not much, just working on some new projects. How about you?</p>
                <p class="chat-widget-speaker-timestamp">10:06AM</p>
            </div>
        </div>
    </aside>
