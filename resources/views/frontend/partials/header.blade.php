<header class="header">
  <div class="header-actions">
    <div class="header-brand">
      ...
      <h1 class="header-brand-text">Kwarta Klik</h1>
    </div>
  </div>
  <div class="header-actions">
    ...
    <nav class="navigation">
      <ul class="menu-main">
          <li class="menu-main-item">
              <a class="menu-main-item-link" href="{{ asset('assets/#') }}">Home</a>
          </li>
          <li class="menu-main-item">
              <a class="menu-main-item-link" href="{{ asset('assets/#') }}">Careers</a>
          </li>
          <li class="menu-main-item">
              <a class="menu-main-item-link" href="{{ asset('assets/#') }}">Faqs</a>
          </li>
          <li class="menu-main-item">
              <p class="menu-main-item-link">
                  <svg class="icon-dots">
                      <use xlink:href="{{ asset('assets/#svg-dots') }}"></use>
                  </svg>
              </p>
              <ul class="menu-main">
                  <li class="menu-main-item">
                      <a class="menu-main-item-link" href="{{ asset('assets/#') }}">About Us</a>
                  </li>
                  <li class="menu-main-item">
                      <a class="menu-main-item-link" href="{{ asset('assets/#') }}">Our Blog</a>
                  </li>
                  <li class="menu-main-item">
                      <a class="menu-main-item-link" href="{{ asset('assets/#') }}">Contact Us</a>
                  </li>
                  <li class="menu-main-item">
                      <a class="menu-main-item-link" href="{{ asset('assets/#') }}">Privacy Policy</a>
                  </li>
              </ul>
          </li>
      </ul>
  ...
  <div class="header-actions search-bar">
    ...
    <div class="dropdown-box padding-bottom-small header-search-dropdown">
        ...
        <div class="dropdown-box-list small no-scroll">
            <a class="dropdown-box-list-item" href="{{ asset('assets/profile-timeline.html') }}">
                <div class="user-status notification">
                    <div class="user-status-avatar">
                        <div class="user-avatar small no-outline">
                            <div class="user-avatar-content">
                                <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/05.jpg') }}"></div>
                            </div>
                    ...
                    <div class="user-status-icon">
                        <svg class="icon-friend">
                            <use xlink:href="{{ asset('assets/#svg-friend') }}"></use>
                        </svg>
                    </div>
                </div>
            </a>
            <a class="dropdown-box-list-item" href="{{ asset('assets/profile-timeline.html') }}">
                <div class="user-status notification">
                    <div class="user-status-avatar">
                        <div class="user-avatar small no-outline">
                            <div class="user-avatar-content">
                                <div class="hexagon-image-30-32" data-src="{{ asset('assets/img/avatar/15.jpg') }}"></div>
                            </div>
                            <div class="user-avatar-progress">
                                <div class="hexagon-progress-40-44"></div>
                            </div>
        ...
        <div class="dropdown-box-list small no-scroll">
            <a class="dropdown-box-list-item" href="{{ asset('assets/group-timeline.html') }}">
                <div class="user-status notification">
                    <div class="user-status-avatar">
                        <div class="user-avatar small no-border">
                            <div class="user-avatar-content">
                                <div class="hexagon-image-40-44" data-src="{{ asset('assets/img/avatar/24.jpg') }}"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="user-status-icon">
                        <svg class="icon-group">
                            <use xlink:href="{{ asset('assets/#svg-group') }}"></use>
                        </svg>
                    </div>
                </div>
            </a>
        ...
        <div class="dropdown-box-list small no-scroll">
            <a class="dropdown-box-list-item" href="{{ asset('assets/marketplace-product.html') }}">
                <div class="user-status no-padding-top">
                    <div class="user-status-avatar">
                        <figure class="picture small round liquid">
                            <img src="{{ asset('assets/img/marketplace/items/07.jpg') }}" alt="item-07">
                        </figure>
                    </div>
                    ...
                    <div class="user-status-icon">
                        <svg class="icon-marketplace">
                            <use xlink:href="{{ asset('assets/#svg-marketplace') }}"></use>
                        </svg>
                    </div>
                </div>
            </a>
    ...
    <div class="action-list dark">
          ...
          <div class="dropdown-box-list scroll-small no-hover" data-simplebar>
              ...
              <div class="cart-item-preview">
                <a class="cart-item-preview-image" href="marketplace-product.html">
                  <figure class="picture medium round liquid">
                    <img src="{{ asset('assets/img/marketplace/items/01.jpg') }}" alt="item-01">
                  </figure>
                </a>
            ...
            <div class="dropdown-box-list-item">
              <div class="cart-item-preview">
                <a class="cart-item-preview-image" href="marketplace-product.html">
                  <figure class="picture medium round liquid">
                    <img src="{{ asset('assets/img/marketplace/items/11.jpg') }}" alt="item-11">
                  </figure>
                </a>
            ...
            <div class="dropdown-box-list-item">
              <div class="cart-item-preview">
                <a class="cart-item-preview-image" href="marketplace-product.html">
                  <figure class="picture medium round liquid">
                    <img src="{{ asset('assets/img/marketplace/items/10.jpg') }}" alt="item-10">
                  </figure>
                </a>
                <p class="cart-item-preview-title"><a href="marketplace-product.html">Twitch Stream UI Pack</a></p>
                <p class="cart-item-preview-text">Regular License</p>
            ...
            <div class="dropdown-box-list-item">
              <div class="cart-item-preview">
                <a class="cart-item-preview-image" href="marketplace-product.html">
                  <figure class="picture medium round liquid">
                    <img src="{{ asset('assets/img/marketplace/items/04.jpg') }}" alt="item-04">
                  </figure>
                </a>
      ...
      <div class="action-list-item-wrap">
        ...
        <div class="dropdown-box header-dropdown">
          ...
          <div class="dropdown-box-list no-hover" data-simplebar>
            <div class="dropdown-box-list-item">
              <div class="user-status request">
                <a class="user-status-avatar" href="assets/profile-timeline.html">
                  <div class="user-avatar small no-outline">
                    <div class="user-avatar-content">
                ...
                <p class="user-status-title"><a class="bold" href="assets/profile-timeline.html">Ginny Danvers</a></p>
            ...
            <div class="dropdown-box-list-item">
              <div class="user-status request">
                <a class="user-status-avatar" href="assets/profile-timeline.html">
                  <div class="user-avatar small no-outline">
                    <div class="user-avatar-content">
                      <div class="hexagon-image-30-32" data-src="assets/img/avatar/14.jpg"></div>
                    </div>
                    <div class="user-avatar-progress">
                      <div class="hexagon-progress-40-44"></div>
                    </div>
                ...
                <p class="user-status-title"><a class="bold" href="assets/profile-timeline.html">Paul Lang</a></p>
            ...
            <div class="dropdown-box-list-item">
              <div class="user-status request">
                ...
                <p class="user-status-title"><a class="bold" href="assets/profile-timeline.html">Cassie May</a></p>
                <p class="user-status-text">4 friends in common</p>
                <div class="action-request-list">
                  <div class="action-request accept">
                    <svg class="action-request-icon icon-add-friend">
          ...
          <a class="dropdown-box-button secondary" href="assets/hub-profile-requests.html">View all Requests</a>
        </div>
      </div>
      <div class="action-list-item-wrap">
        <div class="action-list-item header-dropdown-trigger">
  ...
  <a class="dropdown-box-list-item" href="hub-profile-messages.html">
    <div class="user-status">
      <div class="user-status-avatar">
        <div class="user-avatar small no-outline">
          <div class="user-avatar-content">
            <div class="hexagon-image-30-32" data-src="assets/img/avatar/12.jpg"></div>
          </div>
          <div class="user-avatar-progress">
            <div class="hexagon-progress-40-44"></div>
          </div>
