...
<div class="content-grid">
    <div class="section-banner">
        <img class="section-banner-icon" src="assets/img/banner/overview-icon.png" alt="overview-icon">
    ...
    <div class="grid">
        ...
        <div class="grid-content">
            ...
            <div class="widget-box-content padded-for-scroll" data-simplebar>
                ...
                <div class="user-status notification">
                    ...
                    <p class="user-status-title"><a class="bold" href="profile-timeline.html">Sarah Diamond</a> left a like <img class="reaction" src="assets/img/reaction/like.png" alt="reaction-like"> reaction on your <a class="highlighted" href="profile-timeline.html">status update</a></p>
                ...
                <div class="user-status notification">
                    ...
                    <p class="user-status-title"><a class="bold" href="profile-timeline.html">The Green Goo</a> left a love <img class="reaction" src="assets/img/reaction/love.png" alt="reaction-love"> reaction on your <a class="highlighted" href="profile-timeline.html">status update</a></p>
        ...
        <div class="widget-box no-padding">
            ...
            <div class="widget-box-status-content">
                ...
                <img class="video-status-image" src="assets/img/cover/50.jpg" alt="cover-50">
        ...
        <div class="widget-box no-padding">
            ...
            <div class="user-status-list scroll-content">
                ...
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">Marina Valentine</a> left a love <img class="reaction" src="assets/img/reaction/love.png" alt="reaction-love"> reaction on <a class="highlighted" href="profile-timeline.html">Destroy Dex</a>'s <a class="highlighted" href="profile-timeline.html">status update</a></p>
                ...
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">Marina Valentine</a> left a happy <img class="reaction" src="assets/img/reaction/happy.png" alt="reaction-happy"> reaction on <a class="highlighted" href="profile-timeline.html">Neko Bebop</a>'s <a class="highlighted" href="profile-timeline.html">status update</a></p>
                <p class="user-status-timestamp small-space">3 minutes ago</p>
                </div>
                <div class="user-status">
                ...
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">Marina Valentine</a> left a wow! <img class="reaction" src="assets/img/reaction/wow.png" alt="reaction-wow"> reaction on <a class="highlighted" href="profile-timeline.html">Destroy Dex</a>'s <a class="highlighted" href="profile-timeline.html">status update</a></p>
                ...
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">Marina Valentine</a> left a like <img class="reaction" src="assets/img/reaction/like.png" alt="reaction-like"> reaction on <a class="highlighted" href="profile-timeline.html">Nick Grissom</a>'s <a class="highlighted" href="profile-timeline.html">status update</a></p>
                <p class="user-status-timestamp small-space">1 week ago</p>
                </div>
                <div class="user-status">
                <div class="user-status-activity activity-reaction">
                ...
                <p class="user-status-title"><a class="bold" href="profile-timeline.html">Marina Valentine</a> left a funny <img class="reaction" src="assets/img/reaction/funny.png" alt="reaction-funny"> reaction on <a class="highlighted" href="profile-timeline.html">Bearded Wonder</a>'s <a class="highlighted" href="profile-timeline.html">status update</a></p>
    ...
    <div class="grid">
        ...
        <div class="achievement-box secondary">
            ...
            <img class="achievement-box-image" src="assets/img/badge/caffeinated-b.png" alt="badge-caffeinated-b">
        ...
        <div class="achievement-box primary">
            <div class="achievement-box-info-wrap">
            <img class="achievement-box-image" src="assets/img/quest/completedq-l.png" alt="quest-completedq-l">
            <div class="achievement-box-info">
    ...
    <div class="grid">
        ...
        <div class="grid-column">
            ...
            <div class="widget-box-content">
                ...
                <div class="country-stat with-progress">
                    <img class="country-stat-image" src="assets/img/flag/usa.png" alt="flag-usa">
                ...
                <div class="country-stat with-progress">
                    <img class="country-stat-image" src="assets/img/flag/india.png" alt="flag-india">
                    <div class="progress-stat small">
                    <div class="bar-progress-wrap">
                ...
                <div class="country-stat with-progress">
                    <img class="country-stat-image" src="assets/img/flag/brazil.png" alt="flag-brazil">
                    <div class="progress-stat small">
                    <div class="bar-progress-wrap">
                ...
                <div class="country-stat">
                    <img class="country-stat-image" src="assets/img/flag/canada.png" alt="flag-canada">
                    <p class="country-stat-title">Canada</p>
                    <p class="country-stat-text">8.922</p>
                </div>
                <div class="country-stat">
                    <img class="country-stat-image" src="assets/img/flag/russia.png" alt="flag-russia">
                    <p class="country-stat-title">Russia</p>
                    <p class="country-stat-text">6.303</p>
                </div>
                <div class="country-stat">
                    <img class="country-stat-image" src="assets/img/flag/turkey.png" alt="flag-turkey">
                    <p class="country-stat-title">Turkey</p>
                    <p class="country-stat-text">6.278</p>
                </div>
                <div class="country-stat">
                    <img class="country-stat-image" src="assets/img/flag/france.png" alt="flag-france">
                    <p class="country-stat-title">France</p>
                    <p class="country-stat-text">4.520</p>
                </div>
                <div class="country-stat">
                    <img class="country-stat-image" src="assets/img/flag/germany.png" alt="flag-germany">
                    <p class="country-stat-title">Germany</p>
                    <p class="country-stat-text">3.225</p>
                </div>
                <div class="country-stat">
                    <img class="country-stat-image" src="assets/img/flag/argentina.png" alt="flag-argentina">
        ...
        <div class="grid-column">
            ...
            <div class="widget-box-content">
                <img class="full-width-image" src="assets/img/flag/map.png" alt="map">
            </div>
            </div>
        </div>
        </div>
